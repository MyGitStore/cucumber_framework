...
public class HomePage extends BasePage {
	...
	public HomePage() {
		...
		addObject("Usermenu",By.id("username"));
		addObject("Usermenu", By.xpath("//div[@class='profileTrigger branding-user-profile bgimg slds-avatar slds-avatar_profile-image-small circular forceEntityIcon']//span[@class='uiImage']"));
